...
class VuePresentation(tk.Tk):
    def __init__(self):
        ...
        self.niveaux = Niveaux("Map.xlsx","Wave.xlsx")
        self.mapp = self.niveaux.dico_niveaux[1]


        self.creer_widgets()

    def creer_widgets(self):
        self.nom = tk.Label(self, text="Tower Defence", bg='lightblue', font=("Algerian", 50))
    ...
    def ouvrir_fenetre_jeu(self):
        fenetre_jeu = VuePrincipale(self,self.mapp, 1000, 700)
        fenetre_jeu.grab_set()

#placer_tour

class VuePrincipale(tk.Toplevel):
    def __init__(self, parent, mapp, l_canvas=900, h_canvas=700):        
